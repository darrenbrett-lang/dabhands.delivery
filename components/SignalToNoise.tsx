...
export const SignalToNoiseDesktop = () => (
  ...
  >
    ...
    {IMPACT_ITEMS.map((item, i) => (
      <text key={item} x="1082" y={168 + i * 18} textAnchor="middle" fontSize="10" fill={GRAPHITE} style={label}>
...
export const SignalToNoiseMobile = () => (
  ...
  >
    ...
    <rect x="92" y="570" width="176" height="140" rx="12" fill="none" stroke={INK} strokeWidth="1.4" />
