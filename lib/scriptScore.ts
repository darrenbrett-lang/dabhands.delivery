...
export const SCORE: Card[] = [
  ...
  },
  {
    ...
    beat: 'PROBLEM',
    intent: 'CONCERNED',
    fullText: ['They **lose it** on the way out... →'],
    cueText: ['LOSE IT', 'WAY OUT'],
    voiceDirection:
      'This deliberately creates an unfinished thought. The next card explains how. Do not give this a full-stop feeling.',
    speakDuration: 2.2,
    holdDuration: 0.5,
  },
  {
    ...
    beat: 'DIAGNOSIS',
    intent: 'INCISIVE',
    fullText: ['traded away in **systems** and **misalignments** →', '**nobody is managing**. ↓↓ ○○'],
    cueText: ['TRADED AWAY', 'SYSTEMS · MISALIGNMENTS', 'NOBODY MANAGING'],
    voiceDirection:
      'This is an important insight. The key phrase is “nobody is managing.” Do not rush it. The systems and misalignments are symptoms. The deeper issue is that nobody owns the joins.',
    speakDuration: 4.0,
    holdDuration: 1.2,
  },
  {
  ...
  },
  {
    ...
    voiceDirection:
      'Important three-stage rhythm: strategy, system, customer. Allow each stage to register. Do not race the list. This is a concise articulation of what you actually do.',
    speakDuration: 4.2,
    holdDuration: 1.0,
  },
  {
