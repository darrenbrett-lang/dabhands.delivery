        ...
        <section className="bg-dab-charcoal text-dab-cream pt-20 md:pt-28 pb-24 md:pb-32">
          <div className="max-w-screen-xl mx-auto px-6 md:px-10 lg:px-16">
            ...
            <div className="pt-10 md:pt-14">
              <div className="grid grid-cols-2 gap-y-16 gap-x-8 md:gap-x-12 lg:gap-x-16">
                {experienceAreas.map((item, i) => (
                  <motion.div
                    ...
                    className={i % 2 === 1 ? 'border-l border-dab-cream/15 pl-6 md:pl-8 lg:pl-10' : 'pr-6 md:pr-8 lg:pr-10'}
                  >
